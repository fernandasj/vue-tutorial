                            ...
                            <div class="field is-grouped" v-for="teste in testes">
                                ...
                                <p class="control">
                                    <a
                                        ...
                                        style=" border-radius: 50%;"
                                        @click="deleteTeste(teste.idTest)"
                                    >
                                        <span class="icon is-small">
...
export default {
    ...
    methods: {
        ...
        deleteTeste(id) {
            this.$axios
                .delete(`${this.$env.SERVER_URI}/tests/${id}`)
                .then(response => {
        ...
        editTeste(id) {
            this.$axios
                .get(`${this.$env.SERVER_URI}/tests/${id}`)
                .then(response => {
