                    ...
                    <div class="field has-addons">
                        <div class="control">
                            <input
                                ...
                                v-model="idQuestion"
                                list="questoes"
                                placeholder="Procure uma questão"
                            />
                        </div>
                        <div class="field">
                            ...
                            <article v-for="q in addQuestoes" class="message is-small">
                                <div class="message-header">
                                    ...
                                    <button
                                        ...
                                        aria-label="delete"
                                        @click="deleteQuestions(q.idQuestion)"
                                    ></button>
                                </div>
                                <div class="message-body">{{q.headQuestion}}</div>
                            </article>
...
export default {
    ...
    methods: {
        ...
        formSubmitQuestion(e) {
            ...
            let currentObj = this;
            this.$axios
                .post(`${this.$env.SERVER_URI}/tests/`, {
